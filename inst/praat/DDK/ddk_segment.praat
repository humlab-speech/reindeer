...
sentence SoundFile /Users/frkkan96/Desktop/exempelinspelning_ddk.wav
real BeginTime 0.0
real EndTime 0.0
...
outTab = Down to Table: "no", 20, "yes","no"
#Append column: "treference"
noRows = Get number of rows

for r from 1 to noRows
	#Set numeric value: r, "treference", beginTime
