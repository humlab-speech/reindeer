...
furnish(ae,forest,FORMANTS2="fm","bw","fm",explicitExt="fm2",.force=TRUE) |> 
furnish("fms",FORMANTS="fm","bw","dft","fm",explicitExt="fms",.force=TRUE)
...
segments_following |>
  quantify(forest, windowShift=10)
...
segments_following |>
  quantify(praat_voice_report,c=1)
