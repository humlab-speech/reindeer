...
#furnish("fms",FORMANTS="fm","bw","dft","fm",explicitExt="fms",.force=TRUE,.parameter_log_excel = "~/Desktop/2.xlsx")
...
segments_following |>
  quantify(forest, windowShift=10,nominalF1 = 522,.recompute = FALSE, .naively = FALSE,.cache_file = TRUE,.clear_cache = TRUE,.parameter_log_excel = "~/Desktop/1.xlsx")
