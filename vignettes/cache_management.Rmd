...
2. **Simulation Cache** (user-specified): Stores results from `quantify_simulate()` and `enrich_simulate()`

> **Note:** Draft annotation caches (`.draft_cache/`) are managed by the [protoscribe](https://github.com/humlab-speech/protoscribe) package as of v0.3.0.
